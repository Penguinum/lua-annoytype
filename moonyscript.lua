...
do
local _ENV = _ENV
package.preload[ "moonscript.cmd.args" ] = function( ... ) local arg = _G.arg;
local unpack
...
do
local _ENV = _ENV
package.preload[ "moonscript.cmd.coverage" ] = function( ... ) local arg = _G.arg;
local log
log = function(str)
  if str == nil then
    str = ""
...
do
local _ENV = _ENV
package.preload[ "moonscript.cmd.lint" ] = function( ... ) local arg = _G.arg;
local insert
insert = table.insert
local Set
...
do
local _ENV = _ENV
package.preload[ "moonscript.cmd.moonc" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "moonscript.cmd.watchers" ] = function( ... ) local arg = _G.arg;
local remove_dupes
...
do
local _ENV = _ENV
package.preload[ "moonscript.compile" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "moonscript.compile.statement" ] = function( ... ) local arg = _G.arg;
local ntype
...
do
local _ENV = _ENV
package.preload[ "moonscript.compile.value" ] = function( ... ) local arg = _G.arg;
local util = require("moonscript.util")
local data = require("moonscript.data")
local ntype
ntype = require("moonscript.types").ntype
...
do
local _ENV = _ENV
package.preload[ "moonscript.data" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "moonscript.dump" ] = function( ... ) local arg = _G.arg;
local flat_value
...
do
local _ENV = _ENV
package.preload[ "moonscript.errors" ] = function( ... ) local arg = _G.arg;
local util = require("moonscript.util")
...
do
local _ENV = _ENV
package.preload[ "moonscript.init" ] = function( ... ) local arg = _G.arg;
do
...
do
local _ENV = _ENV
package.preload[ "moonscript.line_tables" ] = function( ... ) local arg = _G.arg;
return { }
...
do
local _ENV = _ENV
package.preload[ "moonscript.parse" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "moonscript.parse.env" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "moonscript.parse.literals" ] = function( ... ) local arg = _G.arg;
local safe_module
...
do
local _ENV = _ENV
package.preload[ "moonscript.parse.util" ] = function( ... ) local arg = _G.arg;
local unpack
unpack = require("moonscript.util").unpack
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform" ] = function( ... ) local arg = _G.arg;
return {
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform.accumulator" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform.class" ] = function( ... ) local arg = _G.arg;
local NameProxy, LocalName
do
  local _obj_0 = require("moonscript.transform.names")
  NameProxy, LocalName = _obj_0.NameProxy, _obj_0.LocalName
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform.comprehension" ] = function( ... ) local arg = _G.arg;
local is_value
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform.destructure" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform.names" ] = function( ... ) local arg = _G.arg;
local build
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform.statement" ] = function( ... ) local arg = _G.arg;
local Transformer
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform.statements" ] = function( ... ) local arg = _G.arg;
local types = require("moonscript.types")
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform.transformer" ] = function( ... ) local arg = _G.arg;
local ntype
ntype = require("moonscript.types").ntype
local Transformer
do
...
do
local _ENV = _ENV
package.preload[ "moonscript.transform.value" ] = function( ... ) local arg = _G.arg;
local Transformer
Transformer = require("moonscript.transform.transformer").Transformer
...
do
local _ENV = _ENV
package.preload[ "moonscript.types" ] = function( ... ) local arg = _G.arg;
local util = require("moonscript.util")
local Set
Set = require("moonscript.data").Set
local insert
...
do
local _ENV = _ENV
package.preload[ "moonscript.util" ] = function( ... ) local arg = _G.arg;
local concat
concat = table.concat
...
do
local _ENV = _ENV
package.preload[ "moonscript.version" ] = function( ... ) local arg = _G.arg;
local version = "0.5.0"
return {
  version = version,
